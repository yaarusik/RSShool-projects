import { scoreBlock, mainBlock, categoryBlock, categoryPicturesBlock, eventMemory, questionsCount } from './blocksHide';
...
const renderScorePage = (index, type) => {
    ...
    if (type === 'picture') {
        ...
        let currentPage = scorePicturesPages.filter((item) => item.number === param);
