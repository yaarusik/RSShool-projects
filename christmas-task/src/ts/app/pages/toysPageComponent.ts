  ...
  <main class="toys__cards">
    <div class="container">
      <div class="cards__sort">
        <div class="sort__row">
          <div class="sort__value sort__column">
            <h2 class="value__title general__title">Фильтры по значению</h2>
            <div class="value__row">
              <div class="value__form form__sort">
                <div class="value__text">Форма:</div>
                <div class="value__form-icons">
                  <button class="value__form-img bcg__size" data-type="form" data-filter="шар"></button>
                  <button class="value__form-img bcg__size" data-type="form" data-filter="колокольчик"></button>
                  <button class="value__form-img bcg__size" data-type="form" data-filter="шишка"></button>
                  <button class="value__form-img bcg__size" data-type="form" data-filter="фигурка"></button>
                  <button class="value__form-img bcg__size" data-type="form" data-filter="снежинка"></button>
                </div>
              </div>
              <div class="value__color value__form">
                <div class="value__text">Цвет:</div>
                <div class="value__form-icons value-cubes">
                  <button class="value__form-cube type__form" data-type="color" data-filter="желтый"></button>
                  <button class="value__form-cube" data-type="color" data-filter="красный"></button>
                  <button class="value__form-cube" data-type="color" data-filter="синий"></button>
                  <button class="value__form-cube" data-type="color" data-filter="зелёный"></button>
                  <button class="value__form-cube" data-type="color" data-filter="белый"></button>
                </div>
              </div>
              <div class="value__size value__form">
                <div class="value__text">Размер:</div>
                <div class="value__form-icons value__size-icons">
                  <div class="value__size-big size__option" data-type="size" data-filter="большой"></div>
                  <div class="value__size-medium size__option" data-type="size" data-filter="средний"></div>
                  <div class="value__size-small size__option" data-type="size" data-filter="малый"></div>
                </div>
              </div>
              <div class="value__favorite value__form">
                <div class="value__text">Только любимые:</div>
                <div class="value__ok">
                  <button class="value__checkbox" data-type="favorite" data-filter="true" id="ok"></button>
                </div>
              </div>
            </div>
          </div>
          <div class="sort__range sort__column">
            <h2 class="range__title general__title">Фильтры по диапазону</h2>
            <div class="range__row">
              <div class="range__instance">
                <div class="range__title">Количество экземпляров:</div>
                <div class="count-slider__container">
              ...
              <div class="range__year">
                <div class="range__title year__title">Год приобретения:</div>
              </div>
              <div class="year-slider__container">
                <div class="slider-output"></div>
          ...
          <div class="sort__name sort__column">
            <div class="name__title general__title">Сортировка</div>
            <div class="name__row">
              <div class="name__sort">
                <select class="name__select">
              ...
              <div class="name__setting">
                <button class="name__clear">Сброс фильтров</button>
                <button class="name__clear name__none">Сброс настроек</button>
              </div>
            </div>
          </div>
        </div>
      </div>
      <div class="cards__balls">
        <div class="cards__message"></div>
        <div class="balls"></div>
      </div>
    </div>
  </main>
