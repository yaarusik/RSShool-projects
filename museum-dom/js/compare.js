...
дополнительный функционал стрелка-скролл страницы вверх, с заливающимся фоном в зависимости от высоты сайта.
+ в плеере стрелками вверх и вниз можно регулировать громкость +10`);
